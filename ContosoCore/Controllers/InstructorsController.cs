...
using ContosoCore.Models.ViewModels;
...
namespace ContosoCore.Controllers
{
    public class InstructorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,FirstMidName,LastName,HireDate")] Instructor instructor)
        {
        ...
        public async Task<IActionResult> EditPost(int? id, string[] selectedCourses)
        {
                ...
                i => i.FirstMidName, i => i.LastName, i => i.HireDate, i => i.OfficeAssignment))
            {
                ...
                {
                    ModelState.AddModelError("", "Unable to save Instructor Changes");
                }
                return RedirectToAction("Index");
            }
        ...
        //public async Task<IActionResult> Edit(int id, [Bind("ID,FirstMidName,LastName,HireDate")] Instructor instructor)
        //{
        //    if (id != instructor.ID)
        //    {
        //        return NotFound();
