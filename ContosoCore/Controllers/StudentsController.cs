...
namespace ContosoCore.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FirstMidName,LastName,EnrollmentDate")] Student student)
        {
            ...
            {
                ModelState.AddModelError("CreateError", "Unable to add Student");
            }
        ...
        public async Task<IActionResult> EditPost(int? id)
        {
                    ...
                    studentToUpdate, "", s => s.FirstMidName, s => s.LastName, s => s.EnrollmentDate))
            {
                ...
                {
                    ModelState.AddModelError("Update Error", "Cannot update student - error occurred");
                }
            }
        ...
        public async Task<IActionResult> Delete(int? id, bool? saveChangesError = false)
        {
            ...
            {
                ViewData["ErrorMessage"] = "Delete Error";
            }
